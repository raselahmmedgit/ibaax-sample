...
namespace lab.emailimport.Models
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<GmailContact> GmailContact { get; set; }
        public DbSet<HotmailContact> HotmailContact { get; set; }
        public DbSet<YahooContact> YahooContact { get; set; }
        public DbSet<LinkedInContact> LinkedInContact { get; set; }
        public DbSet<FacebookContact> FacebookContact { get; set; }
