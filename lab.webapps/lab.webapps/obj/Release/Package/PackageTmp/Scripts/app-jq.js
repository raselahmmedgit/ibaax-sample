        ...
        success: function (result) {
            ...
            if (statusValue == "True") {
                ...
                if (actionName == "Add") {
                    ...
                    NotifierForSuccess(messageTextValue);
                }
...
//-----------------------------------------------------
//start toastr notify Funtion
function Notifier(messageType, messageText) {
    if (messageType == 'info') {
        NotifierForInfo(messageText);
    }
    else if (messageType == 'warning') {
        NotifierForWarning(messageText);
    }
    else if (messageType == 'success') {
        NotifierForSuccess(messageText);
    }
...
function NotifierForSuccess(message) {
    //kendo ui progress window close
    CloseAppProgressWindow();
...
function NotifierForInfo(message) {
    //kendo ui progress window close
    CloseAppProgressWindow();
...
function NotifierForWarning(message) {
    //kendo ui progress window close
    CloseAppProgressWindow();
...
function NotifierForError(message) {
    //kendo ui progress window close
    CloseAppProgressWindow();
...
$(document).ready(function () {
    ...
    //-----------------------------------------------------
    //add Common
    $('#lnkAddCommon').on('click', function () {
    ...
    //-----------------------------------------------------
    //detail Common
    $('.lnkDetailCommon').on('click', function () {
    ...
    //-----------------------------------------------------
    //edit Common
    $('.lnkEditCommon').on('click', function () {
    ...
    //-----------------------------------------------------
    //delete Common
    $('.lnkDeleteCommon').on('click', function () {
